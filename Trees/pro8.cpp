// Finding the number of leaves in a binary tree and with a similar logic of this can be used to find the number of full nodes
//and half nodes
...
int main() {
	...
	treenode *root;
	createtree(&root, 50);
	cout << "The number of leaves of this binary tree is " << numoflea(root) <<endl;
	return 0;
}
